...
# Creating a vector with values random distribution of 100 values
...
#Formula 
#y=y=β0+β1x+e
#Here the values of β0 =1 and β1 = 0.5
...
plot(y~x)
```
#Frrom the chart it is observed that for x and y it is a positive relationship and it is linear 
